...
```{r}
H00 <- 'group1 == group2; group2 == group3'
H01 <- 'group1 == group2'
H02 <- 'group1 == group3'
H03 <- 'group2 == group3'
```

In case there are many possibilies, you do not want to write these out. In that case, use automated code, as given at the end of this tutorial.
