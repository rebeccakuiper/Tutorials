...
# Estimates and CIs
standardizedSolution(fit1)[1:12, c(1:4,8:9)]
...
"
set.seed(100)
results1_AIC <- gorica(fit1, hypotheses1_AIC, standardize = TRUE) # Note: Complement is Unconstrained here which is the default
results1_AIC
#
#   loglik   penalty gorica  gorica_weights
#H1 -373.626 0.000   747.253 0.000         
#Hu 33.581   12.000  -43.162 1.000
