...
# Estimates and CIs
standardizedSolution(fit2)[13:15, c(1:4,8:9)]
...
"
set.seed(100)
results2_AIC <- gorica(fit2, hypotheses2_AIC, standardize = TRUE)
results2_AIC
#
#   loglik   penalty gorica  gorica_weights
#H1 -339.776 0.000   679.551 0.000         
#H2 6.836    1.000   -11.672 0.652         
#H3 6.894    2.000   -9.789  0.254         
#Hu 6.894    3.000   -7.789  0.094
